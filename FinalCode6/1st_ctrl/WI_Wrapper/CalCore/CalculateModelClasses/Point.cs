...
namespace CalculateModelClasses
{
    ...
    public class Point : ICloneable
    {
        ...
        {
            if (Math.Abs(this.x - otherPoint.X) < 0.0000000001 && Math.Abs(this.y - otherPoint.Y) < 0.0000000001 && Math.Abs(this.z - otherPoint.Z) < 0.0000000001)
            { return true; }
            else
            { return false; }
        }
        ...
        {
            if (Math.Abs(this.x - otherPoint.X)<0.0000000001 && Math.Abs(this.y - otherPoint.Y)<0.0000000001)
            { return true; }
            else
            { return false; }
        }
