...
namespace CalculateModelClasses
{
    ...
    public class Triangle : Face, ICloneable
    {
        ...
        public List<Point> GetCrossPointWithRect(Rectangle rect)
        {
            List<Point> crossPoints = new List<Point>();
            //this.lines.AddRange(new AdjacentEdge(this.vertices[0], this.vertices[1]), new AdjacentEdge(this.vertices[1], this.vertices[2]), new AdjacentEdge(this.vertices[0], this.vertices[2]));
            this.lines.Add(new AdjacentEdge(this.vertices[0], this.vertices[1]));
            this.lines.Add(new AdjacentEdge(this.vertices[1], this.vertices[2]));
            this.lines.Add(new AdjacentEdge(this.vertices[0], this.vertices[2]));
            //this.lines.Add(new AdjacentEdge(vertex1, vertex2));
            //this.lines.Add(new AdjacentEdge(vertex1, vertex3));
            //this.lines.Add(new AdjacentEdge(vertex2, vertex3));
            for (int i = 0; i < this.lines.Count ; i++)
            {
                crossPoints.Add(lines[i].GetCrossPointWithOtherLineInXY(rect.LeftLine));
                crossPoints.Add(lines[i].GetCrossPointWithOtherLineInXY(rect.RightLine));
                crossPoints.Add(lines[i].GetCrossPointWithOtherLineInXY(rect.TopLine));
                crossPoints.Add(lines[i].GetCrossPointWithOtherLineInXY(rect.BottomLine));
            }
            return crossPoints;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Bounds3 WorldBound()
        {
            Bounds3 b = new Bounds3(this.vertices[0], this.vertices[1]);
            b = b.Union(this.vertices[2]);
            return b;
        }
