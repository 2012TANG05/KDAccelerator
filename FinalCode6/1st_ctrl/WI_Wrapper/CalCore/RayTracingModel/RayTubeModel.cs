...
namespace RayCalInfo
{
    ...
    public class RayTubeModel
    {
        ...
        public RayTubeModel(List<OneRayModel> rayModels, Point launchPoint, AdjacentEdge launchEdge, int reflectionTimes = 0,
            int diffractionTimes = 0, int tessellationTimes = 0)
        {
            if (rayModels == null || rayModels.Count != 3)
            {
                throw new ArgumentException("构造射线管模型时，输入的参数有错");
        ...
        public void UpdateAreaSituationFlag(ReceiveArea reArea)
        {
            ...
            {
                Point LeftBottom = new Point(reArea.areaSituationRect[i].LeftBottomPoint);
                LeftBottom.X -= 100;LeftBottom.Y -= 100;
                Point LeftTop = new Point(reArea.areaSituationRect[i].LeftTopPoint);
                LeftTop.X -= 100;LeftTop.Y += 100;
                Point RightBottom = new Point(reArea.areaSituationRect[i].RightBottomPoint);
                RightBottom.X += 100;RightBottom.Y -= 100;
                Point RightTop = new Point(reArea.areaSituationRect[i].RightTopPoint);
                RightTop.X += 100;RightTop.Y += 100;
                Rectangle currentRect = new Rectangle(LeftBottom, RightBottom, LeftTop, RightTop);
        ...
        public bool JudgeIfThisModelNeedToBeDivided()
        {
            switch (this.crossType)
            {
                ...
                case RayTubeCrossType.TaTaTb_C:
                case RayTubeCrossType.TaTbTa_C:
                case RayTubeCrossType.TaTbTb_C:
                case RayTubeCrossType.TaTaTa_S:
                case RayTubeCrossType.TaTbTc_C:
                case RayTubeCrossType.TaTbTc_AA:
                    return false;
                default:
        ...
        public List<RayTubeModel> GetDivisionRayTubeModels()
        {
            ...
            else
            {
                ...
                {
                    return this.GetFlatTubeDivisionModels();
                }
                else
                {
                    return this.GetCurveTubeDivisionModels();
                }
            }
        }
        ...
        /// </summary>
        /// <returns>细分后的射线管模型</returns>
        private List<RayTubeModel> GetFlatTubeDivisionModels()
        {
            //三角形截面射线管不会从绕射点上发出
            ...
            OneRayModel middleRayModelOf01, middleRayModelOf02, middleRayModelOf12;
            //射线管是从辐射源或特殊绕射点发出
            ...
            {
                //射线0与射线1的中间射线模型
                middleRayModelOf01 = new OneRayModel(this.oneRayModels[0].LaunchNode,
                new RayInfo(this.oneRayModels[0].LaunchNode.Position, this.oneRayModels[0].LaunchRay.RayVector.GetMiddleVectorOfTwoVectors(this.oneRayModels[1].LaunchRay.RayVector)));
                //射线0与射线2的中间射线模型
                middleRayModelOf02 = new OneRayModel(this.oneRayModels[0].LaunchNode,
                new RayInfo(this.oneRayModels[0].LaunchNode.Position, this.oneRayModels[0].LaunchRay.RayVector.GetMiddleVectorOfTwoVectors(this.oneRayModels[2].LaunchRay.RayVector)));
                //射线1与射线2的中间射线模型
                middleRayModelOf12 = new OneRayModel(this.oneRayModels[1].LaunchNode,
                new RayInfo(this.oneRayModels[1].LaunchNode.Position, this.oneRayModels[1].LaunchRay.RayVector.GetMiddleVectorOfTwoVectors(this.oneRayModels[2].LaunchRay.RayVector)));
            }
            else //射线管是反射射线管
            {
                Point middlePointInRays01 = this.oneRayModels[0].LaunchNode.Position.GetMiddlePointWithOtherPoint(this.oneRayModels[1].LaunchNode.Position);
                Point middlePointInRays02 = this.oneRayModels[0].LaunchNode.Position.GetMiddlePointWithOtherPoint(this.oneRayModels[2].LaunchNode.Position);
                Point middlePointInRays12 = this.oneRayModels[1].LaunchNode.Position.GetMiddlePointWithOtherPoint(this.oneRayModels[2].LaunchNode.Position);
                //转换成节点
                Node middleNodeInRays01 = this.StructureNewLaunchNode(middlePointInRays01);
                Node middleNodeInRays02 = this.StructureNewLaunchNode(middlePointInRays02);
                Node middleNodeInRays12 = this.StructureNewLaunchNode(middlePointInRays12);
                //
                middleRayModelOf01 = new OneRayModel(middleNodeInRays01, new RayInfo(middlePointInRays01, new SpectVector(this.launchPoint, middlePointInRays01)));
                middleRayModelOf02 = new OneRayModel(middleNodeInRays02, new RayInfo(middlePointInRays02, new SpectVector(this.launchPoint, middlePointInRays02)));
                middleRayModelOf12 = new OneRayModel(middleNodeInRays12, new RayInfo(middlePointInRays12, new SpectVector(this.launchPoint, middlePointInRays12)));
            }
            //
            RayTubeModel firstRayTube = new RayTubeModel(new List<OneRayModel> { this.oneRayModels[0], middleRayModelOf01, middleRayModelOf02 },
                this.launchPoint, this.reflectionTimes, this.diffractionTimes, this.tessellationTimes + 1);
            //
            RayTubeModel secondRayTube = new RayTubeModel(new List<OneRayModel> { this.oneRayModels[1], middleRayModelOf01, middleRayModelOf12 },
                this.launchPoint, this.reflectionTimes, this.diffractionTimes, this.tessellationTimes + 1);
            //
            RayTubeModel thirdRayTube = new RayTubeModel(new List<OneRayModel> { this.oneRayModels[2], middleRayModelOf12, middleRayModelOf02 },
                this.launchPoint, this.reflectionTimes, this.diffractionTimes, this.tessellationTimes + 1);
            //
            RayTubeModel forthRayTube = new RayTubeModel(new List<OneRayModel> { middleRayModelOf01, middleRayModelOf02, middleRayModelOf12 },
                this.launchPoint, this.reflectionTimes, this.diffractionTimes, this.tessellationTimes + 1);
            firstRayTube.FatherRayTube = secondRayTube.FatherRayTube = thirdRayTube.FatherRayTube = forthRayTube.FatherRayTube = this.FatherRayTube;
            return new List<RayTubeModel> { firstRayTube, secondRayTube, thirdRayTube, forthRayTube };
        }
        ...
        /// </summary>
        /// <returns>细分后的射线管模型</returns>
        private List<RayTubeModel> GetCurveTubeDivisionModels()
        {
            List<RayTubeModel> divisionModels = new List<RayTubeModel>();
            OneRayModel middleRayModelOf01, middleRayModelOf02, middleRayModelOf12;
            if (this.launchType == LaunchType.Line)//射线管从线段发射
            {
                ...
                Point crossPoint0 = this.oneRayModels[0].LaunchRay.GetPointOnRayVector(1);
                Point crossPoint1 = this.oneRayModels[1].LaunchRay.GetPointOnRayVector(1);
                Point crossPoint2 = this.oneRayModels[2].LaunchRay.GetPointOnRayVector(1);
                Point middlePointIn01 = crossPoint0.GetMiddlePointWithOtherPoint(crossPoint1);
                Point middlePointIn02 = crossPoint0.GetMiddlePointWithOtherPoint(crossPoint2);
                Point middlePointIn12 = crossPoint1.GetMiddlePointWithOtherPoint(crossPoint2);
                Point launchPointOnEdgeOf01 = this.launchEdge.GetInfiniteDiffractionPoint(this.launchPoint, middlePointIn01);
                Point launchPointOnEdgeOf02 = this.launchEdge.GetInfiniteDiffractionPoint(this.launchPoint, middlePointIn02);
                Point launchPointOnEdgeOf12 = this.launchEdge.GetInfiniteDiffractionPoint(this.launchPoint, middlePointIn12);
                if (launchPointOnEdgeOf01 == null || launchPointOnEdgeOf02 == null || launchPointOnEdgeOf12==null)
                {
                   return new List<RayTubeModel>(); 
                }
                ...
                {
                    //射线0与射线1的中间射线模型
                    Node launchNodeOf01 = this.StructureNewLaunchNode(launchPointOnEdgeOf01);
                    middleRayModelOf01 = new OneRayModel(launchNodeOf01, new RayInfo(launchPointOnEdgeOf01, middlePointIn01));
                    //射线0与射线2的中间射线模型
                    Node launchNodeOf02 = this.StructureNewLaunchNode(launchPointOnEdgeOf02);
                    middleRayModelOf02 = new OneRayModel(launchNodeOf02, new RayInfo(launchPointOnEdgeOf02, middlePointIn02));
                    //射线1与射线2的中间射线模型
                    Node launchNodeOf12 = this.StructureNewLaunchNode(launchPointOnEdgeOf12);
                    middleRayModelOf12 = new OneRayModel(launchNodeOf12, new RayInfo(launchPointOnEdgeOf12, middlePointIn12));
                }
                else if (this.oneRayModels[0].LaunchNode.NodeStyle == NodeStyle.ReflectionNode)
                {
                    ...
                    Point crossPointOfMiddleRay01 = new RayInfo(launchPointOnEdgeOf01, middlePointIn01).GetCrossPointWithFace(reflectionLaunchFace);
                    Point crossPointOfMiddleRay02 = new RayInfo(launchPointOnEdgeOf02, middlePointIn02).GetCrossPointWithFace(reflectionLaunchFace);
                    Point crossPointOfMiddleRay12 = new RayInfo(launchPointOnEdgeOf12, middlePointIn12).GetCrossPointWithFace(reflectionLaunchFace);
                    if (crossPointOfMiddleRay01 == null || crossPointOfMiddleRay02 == null || crossPointOfMiddleRay12 == null)
                    {
                        return new List<RayTubeModel>();
                    }
                    //转换成节点
                    Node crossNodeOfMiddleRay01 = this.StructureNewLaunchNode(crossPointOfMiddleRay01);
                    Node crossNodeOfMiddleRay02 = this.StructureNewLaunchNode(crossPointOfMiddleRay02);
                    Node crossNodeOfMiddleRay12 = this.StructureNewLaunchNode(crossPointOfMiddleRay12);
                    //
                    middleRayModelOf01 = new OneRayModel(crossNodeOfMiddleRay01, new RayInfo(crossPointOfMiddleRay01, middlePointIn01));
                    middleRayModelOf02 = new OneRayModel(crossNodeOfMiddleRay02, new RayInfo(crossPointOfMiddleRay02, middlePointIn02));
                    middleRayModelOf12 = new OneRayModel(crossNodeOfMiddleRay12, new RayInfo(crossPointOfMiddleRay12, middlePointIn12));
                }
                else
                {
            ...
            RayTubeModel firstRayTube = new RayTubeModel(new List<OneRayModel> { this.oneRayModels[0], middleRayModelOf01, middleRayModelOf02 },
                this.launchPoint, this.launchEdge, this.reflectionTimes, this.diffractionTimes, this.tessellationTimes + 1);
            //
            RayTubeModel secondRayTube = new RayTubeModel(new List<OneRayModel> { this.oneRayModels[1], middleRayModelOf01, middleRayModelOf12 },
                this.launchPoint, this.launchEdge, this.reflectionTimes, this.diffractionTimes, this.tessellationTimes + 1);
            //
        ...
        public List<RayTubeModel> GetNextRayTubeModels()
        {
            ...
            {
                nextModels.AddRange(this.GetNextRayTubeModelsWhenTaTaFb_A(this.oneRayModels[0], this.oneRayModels[1], this.oneRayModels[2]));
            }
            else if (this.crossType == RayTubeCrossType.TaTbTa_A)//射线0,2的交点在一个三角面,射线1的在相邻三角面
            {
                nextModels.AddRange(this.GetNextRayTubeModelsWhenTaTaFb_A(this.oneRayModels[0], this.oneRayModels[2], this.oneRayModels[1]));
            }
            else if (this.crossType == RayTubeCrossType.TaTbTb_A)//射线1,2的交点在一个三角面,射线0的在相邻三角面
            {
                nextModels.AddRange(this.GetNextRayTubeModelsWhenTaTaFb_A(this.oneRayModels[1], this.oneRayModels[2], this.oneRayModels[0]));
            }
            else if (this.crossType == RayTubeCrossType.TaTaTb_C)//射线0,1的交点在一个三角面,射线2的交点在不相邻但有一个公共顶点的三角面
            {
                nextModels.AddRange(this.GetNextRayTubeModelsWhenTaTaTb_C(this.oneRayModels[0], this.oneRayModels[1], this.oneRayModels[2]));
            }
            else if (this.crossType == RayTubeCrossType.TaTbTa_C)//射线0,2的交点在一个三角面,射线1的交点在不相邻但有一个公共顶点的三角面
            {
                nextModels.AddRange(this.GetNextRayTubeModelsWhenTaTaTb_C(this.oneRayModels[0], this.oneRayModels[2], this.oneRayModels[1]));
            }
            else if (this.crossType == RayTubeCrossType.TaTbTb_C)//射线1,2的交点在一个三角面,射线0的交点在不相邻但有一个公共顶点的三角面
            {
                nextModels.AddRange(this.GetNextRayTubeModelsWhenTaTaTb_C(this.oneRayModels[1], this.oneRayModels[2], this.oneRayModels[0]));
            }
            else if (this.crossType == RayTubeCrossType.TaTbTc_C)//射线0,1,2的交点所在的三个面可能不相邻，但是都有一个公共的点
            {
                nextModels.AddRange(this.GetNextRayTubeModelsWhenTaTbTc_C(this.oneRayModels[0], this.oneRayModels[1], this.oneRayModels[2]));
            }
            else if (this.crossType == RayTubeCrossType.TaTbTc_AA)//射线0,1,2的交点所在的三角面两两相邻
            {
                nextModels.AddRange(this.GetNextRayTubeModelsWhenTaTbTc_AA(this.oneRayModels[0], this.oneRayModels[1], this.oneRayModels[2]));
            }
            for (int i = 0; i < nextModels.Count; i++)
            {
                nextModels[i].FatherRayTube = this;
            }
        ...
        /// <returns>下一阶段的射线管模型</returns>
        private List<RayTubeModel> GetNextRayTubeModelsWhenTaTaFb_A(OneRayModel sameFaceRay1, OneRayModel sameFaceRay2, OneRayModel otherFaceRay)
        {
            List<RayTubeModel> nextModels = new List<RayTubeModel>();
        ...
        private List<Face> GetFacesFromBeginCrossNodeToTargetCrossNode(Node beginNode, Node targetNode, Point commonPoint)
        {
            ...
            while (currentFaces.Count != 0 && !currentFaces.Peek().FaceID.IsSameID(targetNode.ReflectionFace.FaceID))
            {
                ...
                for (int i = 0; i < paramFace.Lines.Count; i++)
                {
                    ...
                    {
                        if (paramFace.Lines[i].IsDiffractionEdge == false)
                        {
                            continue;
                        }
        ...
        private RayTubeModel GetReflectionModels(List<Node> crossNodes, Face reflectionFace)
        {
            ...
            if (this.tubeType == TubeType.FlatTube)//平面射线管，产生的反射射线管是点发射平面射线管
            {
                ...
                reflectionTube = new RayTubeModel(reflectionRayModels, nextLaunchPoint, this.reflectionTimes + 1,
                    this.diffractionTimes, this.tessellationTimes);
            }
            else if (this.tubeType == TubeType.CurveTube)//曲面射线管产生的反射射线管是棱发射曲面射线管
            {
                ...
                reflectionTube = new RayTubeModel(reflectionRayModels, nextLaunchPoint, nextLaunchEdge,
                    this.reflectionTimes + 1, this.diffractionTimes, this.tessellationTimes);
            }
            else
            { return null; }
            ...
            if (diffractionRays[0][0].RayVector.IsParallel(diffractionRays[1][0].RayVector))
            {
                ...
                for (int j = 0; j < leftRayModels.Count - 1; j++)
                {
                    diffractionModels.Add(new RayTubeModel(new List<OneRayModel> { leftRayModels[j], rightRayModels[j], leftRayModels[j + 1] },
                        leftPoint, this.reflectionTimes, this.diffractionTimes + 1, this.tessellationTimes));
            ...
            else
            {
                ...
                for (int j = 0; j < leftRayModels.Count - 1; j++)
                {
                    diffractionModels.Add(new RayTubeModel(new List<OneRayModel> { leftRayModels[j], rightRayModels[j], leftRayModels[j + 1] },
                        ...
                        this.reflectionTimes, this.diffractionTimes + 1, this.tessellationTimes));
                    diffractionModels.Add(new RayTubeModel(new List<OneRayModel> { rightRayModels[j + 1], leftRayModels[j + 1], rightRayModels[j] },
        ...
        private void UpdataRayTubeCrossFlagWhenTTT()
        {
            ...
            {
                List<Point> commomPointsOfFace0Ang1 = this.oneRayModels[0].CrossNode.ReflectionFace.GetCommonPointsWithOtherFace(this.oneRayModels[1].CrossNode.ReflectionFace);
                List<Point> commomPointsOfFace0And2 = this.oneRayModels[0].CrossNode.ReflectionFace.GetCommonPointsWithOtherFace(this.oneRayModels[2].CrossNode.ReflectionFace);
                List<Point> commomPointsOfFace1And2 = this.oneRayModels[1].CrossNode.ReflectionFace.GetCommonPointsWithOtherFace(this.oneRayModels[2].CrossNode.ReflectionFace);
                if (commomPointsOfFace0And2.Count == 0 || commomPointsOfFace0Ang1.Count == 0 || commomPointsOfFace1And2.Count == 0)
                {
                    //三个三角面没有相互联系
                    this.crossType = RayTubeCrossType.TaTbTc_D;
                }
                else if (commomPointsOfFace0And2.Count == 1 && commomPointsOfFace0Ang1.Count == 1 && commomPointsOfFace1And2.Count == 1 &&
                    !commomPointsOfFace0Ang1[0].equal(commomPointsOfFace0And2[0]))
                {
                    //三角面0,1和三角面0，2的公共点不是一个点，说明三个三角面没有一个公共的点
                    this.crossType = RayTubeCrossType.TaTbTc_D;
                }
                else if (commomPointsOfFace0And2.Count == 2 && commomPointsOfFace0Ang1.Count == 2 && commomPointsOfFace1And2.Count == 2)
                {
                    //三个三角面两两相邻
                    this.crossType = RayTubeCrossType.TaTbTc_AA;
                }
                else
                {
                    //三角面0,1,2有一个公共的点，但是不是两两相邻
                    this.crossType = RayTubeCrossType.TaTbTc_C;
                }
            }
        }
        public Object Clone()
    ...
    public enum RayTubeCrossType
    {
        ...
        TaTbTc_AA,//射线0,1,2的交点在三个两两相邻的三角面
        TaTbTc_C,//射线0,1,2的交点在三个不同的但是都有一个相同公共点的三角面
        TaTbTc_D,//射线0,1,2的交点在三个没关联的三角面
